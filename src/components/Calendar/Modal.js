...
import { ModalBackground, ModalBottom, ModalContainer, ModalExit, 
    ModalBody, ModalTitle, ModalUpload, ModalTextEntry, 
    ModalImageContainer, ImagePreview } from './common';
        ...
        <ModalBackground>
            <ModalContainer>
                ...
                <ModalBody> 
                    ...
                    <ModalTextEntry type="text" ref={weightRef} placeholder={`${weight} (lbs)`} required/>
                </ModalBody>
                <ModalBottom>
                    <ModalExit type="button" onClick={closeModal}>
                        Exit
                    </ModalExit>
                    <ModalUpload type="submit" onClick={handleUpload} disabled={loading}>
                        Upload
                    </ModalUpload>
                </ModalBottom>
            </ModalContainer>
